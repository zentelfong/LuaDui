return {
  ...
  ["&Community"] = "组织", -- src\editor\menu_help.lua
  ...
  ["&Edit Project Directory"] = "设置工程目录", -- src\editor\filetree.lua
  ...
  ["&Getting Started Guide"] = "查看新手指导", -- src\editor\menu_help.lua
  ["&Help"] = "帮助", -- src\editor\menu_help.lua
  ["&New Directory"] = "创建目录", -- src\editor\filetree.lua
  ...
  ["&Project Page"] = "项目页", -- src\editor\menu_help.lua
  ...
  ["&Tool Bar"] = "工具条", -- src\editor\menu_view.lua
  ["&Tutorials"] = "示例", -- src\editor\menu_help.lua
  ...
  ["Can't open file '%s': %s"] = "无法打开文件", -- src\editor\singleinstance.lua
  ...
  ["Can't start debugger server at %s:%d: %s."] = "运行调试服务器失败。", -- src\editor\debugger.lua
